...
from .serializers import (
    CategoriaSerializer, SubcategoriaSerializer, LaboratorioSerializer,
    ProductoSerializer, InventarioSerializer, MovimientoInventarioSerializer
)
...
class ProductoViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        queryset = super().get_queryset().select_related(
            'categoria', 'laboratorio', 'subcategoria', 'inventario'
        )
    ...
    def ajustar_stock(self, request, pk=None):
        ...
        if not tipo_movimiento or not cantidad or not motivo:
            return Response(
                {'error': 'Se requiere tipo_movimiento, cantidad y motivo'},
        ...
        try:
            ...
            return Response({'error': f'Error al ajustar stock: {str(e)}'}, 
