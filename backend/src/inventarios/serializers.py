...
class LaboratorioSerializer(serializers.ModelSerializer):
    class Meta:
        model = Laboratorio
        fields = ['id', 'nombre', 'pais', 'telefono', 'email', 'direccion', 
...
class InventarioSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Inventario
        fields = ['id', 'stock_actual', 'stock_reservado', 'stock_disponible', 
...
class ProductoSerializer(serializers.ModelSerializer):
    ...
    laboratorio_id = serializers.PrimaryKeyRelatedField(
        source='laboratorio', queryset=Laboratorio.objects.all(), write_only=True
    )
    subcategoria_id = serializers.PrimaryKeyRelatedField(
        source='subcategoria', queryset=Subcategoria.objects.all(), 
