...
export default function ToggleSubcategoryModal({
  isOpen,
  onClose,
  onConfirm,
  loading,
      ...
      <Card className="w-full max-w-md overflow-hidden">
        ...
        >
          ...
          <CardDescription>
            {isActive ? (
              <>
                La subcategoría <strong>{selected?.nombre}</strong> será dada de baja.
                Podrás dar de alta posteriormente.
              </>
            ) : (
              <>
                La subcategoría <strong>{selected?.nombre}</strong> será dada de alta.
              </>
            )}
          </CardDescription>          
        </CardHeader>
